...
# Session 8 : Recap and consolidate  
...
### Part 2 : Exploratory visual analysis as model-driven process
...
## RQ2 : How did 2019 General Eleciton shift Conservative? 
...
data_gb |>
  ...
  labs(y="Conservative 2019 vote share", x="Conservative 2017 vote share")
...
#### 51% of jobs are professional, so there is a distinctive geog
...
##### Randomly select commute <br> *expect* 51% to be professional
...
##### Randomly select commute <br> *expect* % professional ~ destination
